...
const mockData = [
  { id: 1, data: '01/01/2024 10:00', descricao: 'Aprovador A criado', usuario: 'admin' },
  { id: 2, data: '15/02/2024 14:30', descricao: 'Aprovador B modificado', usuario: 'user1' },
];

const PainelHistoricoAprovadores: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[80]">
      <div className="win-outset p-1 bg-[#C0C0C0] w-[800px] h-[500px] flex flex-col">
        <div className="win-title-bar flex items-center justify-between h-6">
          <span className="font-bold ml-1">Painel de Histórico de Aprovadores</span>
...
export default PainelHistoricoAprovadores;
